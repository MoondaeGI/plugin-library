---
name: ppt-plan
description: Use when "xxx 주제로 PPT 만들고 싶어"처럼 발표를 시작하지만 자료·발표 전략·페이지 구성이 아직 안 정해졌을 때 — 무엇을 조사하고, 어떻게 발표 전략을 짜고, 페이지마다 무슨 메시지를 담을지 논의로 확정한다. 전략 상담만 받고 끝나도 된다. 파일 제작(.pptx)은 ppt-create.
---
